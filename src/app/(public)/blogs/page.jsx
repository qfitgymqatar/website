          ...
          {data.blogs.map((blog) => (
            <div key={blog.id} className="blog-card">
              ...
              <div className="blog-content">
                ...
                <p>{blog.content}</p>
                <Link href={`/blog/${blog.id}`} className="btn-primary" style={{marginTop: '20px', padding: '10px 20px', fontSize: '0.9rem', alignSelf: 'flex-start', textDecoration: 'none'}}>Read More</Link>
              </div>
            </div>
          ))}
        </div>
